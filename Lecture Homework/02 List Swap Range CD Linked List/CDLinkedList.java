public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) {
		...
		if (!(s1 instanceof DListIterator) || !(f1 instanceof DListIterator) ||
				!(s2 instanceof DListIterator) || !(f2 instanceof DListIterator)) {
			return;
		}
		
		DListIterator itrs1 = (DListIterator) s1;
		DListIterator itrf1 = (DListIterator) f1;
		DListIterator itrs2 = (DListIterator) s2;
		DListIterator itrf2 = (DListIterator) f2;
		
		DListIterator beforeitrs1 = new DListIterator (itrs1.currentNode.previousNode);
		DListIterator afteritrf1 = new DListIterator (itrf1.currentNode.nextNode);
		DListIterator beforeitrs2 = new DListIterator (itrs2.currentNode.previousNode);
		DListIterator afteritrf2 = new DListIterator (itrf2.currentNode.nextNode);
		
		if (itrf1.currentNode.nextNode == itrs2.currentNode) { //adjacent swapped range
			beforeitrs1.currentNode.nextNode = itrs2.currentNode;
			itrs2.currentNode.previousNode = beforeitrs1.currentNode;
			
			itrf2.currentNode.nextNode = itrs1.currentNode;
			itrs1.currentNode.previousNode = itrf2.currentNode;
			
			itrf1.currentNode.nextNode = afteritrf2.currentNode;
			afteritrf2.currentNode.previousNode = itrf1.currentNode;
			return;
		}
		beforeitrs1.currentNode.nextNode = itrs2.currentNode;
		itrs2.currentNode.previousNode = beforeitrs1.currentNode;
		
		itrf2.currentNode.nextNode = afteritrf1.currentNode;
		afteritrf1.currentNode.previousNode = itrf2.currentNode;
		
		beforeitrs2.currentNode.nextNode = itrs1.currentNode;
		itrs1.currentNode.previousNode = beforeitrs2.currentNode;
